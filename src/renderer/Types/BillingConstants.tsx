...
export const CARD_MONTHS = [
 ...
 export const CARD_YEARS = [    
  ...
  module.exports.getRegionalStates = (selectedCountry:string) => {
  ...
  module.exports.getRegion = (country:string) => {
  ...
  export const TaskModes = ["Fast","Browser"];